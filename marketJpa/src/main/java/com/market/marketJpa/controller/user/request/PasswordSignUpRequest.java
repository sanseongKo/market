...
public class PasswordSignUpRequest {
    ...
    @Builder
    public PasswordSignUpRequest(String email, String name, String city, String gu, String dong, LocalDate birth, String phoneNumber, String nickname, String password, @Nullable MultipartFile image) {
        this.email = email;
        this.name = name;
        this.city = city;
        this.gu = gu;
    ...
    public PasswordSignUpServiceRequest toServiceRequest() {
